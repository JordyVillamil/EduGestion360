...
class Curso(models.Model):
    ...
    name = models.CharField(
        max_length=100, unique=True, verbose_name="Nombre del Curso"
    )
    description = models.TextField(
        blank=True,
        null=True,
        verbose_name="nivel académico (ej. Primaria, Secundaria, Preparatoria)",
    )
    ...
    tutor = models.ForeignKey(
        ...
        limit_choices_to={
            "role": "docente"
        },  # Solo se puede asignar un Docente como tutor
...
class Materia(models.Model):
    ...
    name = models.CharField(
        max_length=100, unique=True, verbose_name="Nombre de la Materia"
    )
    description = models.TextField(blank=True, null=True, verbose_name="Descripción")

    # Relación ManyToMany: Una materia se imparte en varios cursos
    courses = models.ManyToManyField(
        Curso, related_name="subjects", verbose_name="Cursos donde se imparte"
    )
